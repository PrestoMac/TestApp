...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: pioeQ5cs9E1D/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__k8ZwJ)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__sqvzC, {
                [sty.imghideIcon__sqvzCo882N]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lQIjb)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__fC4G0, {
            [sty.freeBoxhideIcon__fC4G0O882N]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kDyR)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__jhumD, {
              [sty.freeBoxhideTrendTracker__jhumDuaJEy]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__gPuQi, {
                [sty.freeBoxhideTrendTracker__gPuQiuaJEy]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__ekfGz)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__qmR6Q)}>
              <div className={classNames(projectcss.all, sty.freeBox__j58Px)}>
                {renderPlasmicSlot({
